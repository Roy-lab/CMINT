...
main(int argc, const char** argv)
{
	if(argc!=12)
	{
		cout <<"Usage: cmint_array celltype_order genegroup maxk celllineage config rand[rseed|none] outputDir mode[learn|generate|visualize] srcnode inittype[uniform|branchlength] p_diagonal_nonleaf" << endl;
